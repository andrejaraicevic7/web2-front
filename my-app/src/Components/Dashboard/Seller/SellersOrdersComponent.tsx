...
import { GetSellerAllOrders, GetSellerNewOrders } from "../../../Services/OrderService";
...
const SellerOrdersComponent = () => {
    ...
    useEffect(() => {
        const getNewOrders = async() =>{
            const response = await GetSellerNewOrders(user!)
    ...
    useEffect(() => {
        const getAllOrders = async() =>{
            const response = await GetSellerAllOrders(user!)
